...
namespace
{
	...
	static DhtSecureConnectionMgr& GetConnectionMgr()
	{
...
{
	static DhtStates state(GetCertContainer(), GetKeyContainer(), GetServerWhiteList(), &GetLoadedWhiteListImpl, GetDhtStore(), GetConnectionMgr());
